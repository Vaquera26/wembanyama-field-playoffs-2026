...
const T = {
  ...
  es: {
    ...
    conclusion_p1: (games, attempts, on, off, diff) =>
      `La mayoría del análisis defensivo cuenta lo que Wembanyama hace: bloqueos, tiros contestados, bandejas alteradas. Este estudio intenta medir algo diferente — lo que los rivales dejan de intentar cuando él está en cancha. En ${games} partidos y ${attempts} intentos de tiro, los rivales anotaron el ${on}% con él en cancha frente al ${off}% sin él. Una diferencia de ${diff} puntos porcentuales. Ese número es real, pero no captura la historia espacial que hay debajo. Portland apenas cambió desde dónde tiraba. Minnesota y Oklahoma City sí lo hicieron, y de forma significativa. Esa diferencia en la geografía de tiro, no en la eficiencia, es donde vive la señal.`,

    ch_title: 'La Zona Prohibida',
    ch_text:  "La señal espacial más fuerte en los datos no es de eficiencia — es de volumen. Con Wembanyama en cancha, los rivales intentaron 13.9 puntos porcentuales menos tiros desde dentro de la pintura contra Minnesota, y 11.6 menos contra Oklahoma City. Contra Portland la evasión de la pintura apenas se registró. Esa asimetría es el hallazgo: Portland no ajustó su dieta de tiros. Minnesota y Oklahoma City sí lo hicieron, y de forma significativa. Los tiros que redirigieron fueron al perímetro de tres puntos, donde los rivales anotaron 5.9 puntos porcentuales menos con Wembanyama en cancha. No están perdiendo en el aro. Están decidiendo no llegar ahí. Esa geometría conductual — decisiones tomadas antes de que se desarrolle una jugada — es lo que el campo vectorial está mapeando. No resultados. Elecciones.",
